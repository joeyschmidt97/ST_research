...
#**************Block for user******************************************
#**************Setting up*********************************************
iterdb_file_name = 'NSTX141125.iterdb' #name of the iterdb file
geomfile = 'g141125.00800'                     #name of the magnetic geometry file                   #name of the magnetic geometry file
f_max=100        #upper bound of the frequency experimentally observed 
