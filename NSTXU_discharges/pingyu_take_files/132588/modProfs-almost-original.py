...
mode = 'TiTe'
efit_file_name ='g132588.00650'
Z = 6  #Z of impurity species
alpha = 1. #Factor setting the profile change
...
file_out_base = 'NSTX132588_alpha'+str(alpha)+'_omne'
base_number = '132588'  #Used only for iterdb output
...
set_Tesep = False # False on default
